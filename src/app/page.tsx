...
<div className=" mt-[-80px] items-center px-4">

<div className=" h-[20rem]  flex justify-center  items-center px-4">
      <div className=" mt-[-40px]  max-w-7xl text-center pl-2 mx-auto text-m md:text-2xl font-bold text-neutral-800 dark:text-neutral-200">
